...
echo "Installing AUR pkg..."
	sleep 2s
		paru -S prismlauncher zoom gnome-shell-extension-pop-shell-git papirus-folders-git visual-studio-code-bin google-chrome extension-manager github-desktop-bin
